...
const token_key = "MaCléSuperSecrète"; 
    ...
    delete: (req, res, next) => { 
      ...
      getApiToken: (req, res) => { 
        ...
        validate: (req, res, next) => {
          ...
          req.check("email", "L'adresse email est invalide").isEmail();
          req.check("zipCode", "Le code postal doit être un nombre").notEmpty().isInt();
